...
var vaccination3 = new Vaccination('V1003', '2021-05-29', 'PENDING', '-');

var batch1 = new Batch('B1001', '2021-03-19', 2, 12, 5, []);
var batch2 = new Batch('B1002', '2021-04-02', 3, 11, 2, []);
var batch3 = new Batch('B1003', '2021-09-12', 4, 1, 8, []);
...
batch2.batch_vaccinationAdd(vaccination1);
